...
# fork https://raw.githubusercontent.com/a3165458/initia/main/initia.sh
...
function install_node() {
  ...
  echo "export initiad_RPC_PORT=$node_address" >>$HOME/.bashrc
  source $HOME/.bashrc
  ...
  wget https://snapshots.polkachu.com/testnet-snapshots/initia/initia_120971.tar.lz4 -O latest_snapshot.tar.lz4
  initiad tendermint unsafe-reset-all --home $HOME/.initia --keep-addr-book
  lz4 -d -c ./initia_120971.tar.lz4 | tar -xf - -C $HOME/.initia
